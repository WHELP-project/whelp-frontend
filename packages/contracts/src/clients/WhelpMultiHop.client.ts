...
import {
  ...
  AssetValidated,
} from "../types/WhelpMultiHop.types";
export interface WhelpMultiHopReadOnlyInterface {
...
export class WhelpMultiHopQueryClient
  implements WhelpMultiHopReadOnlyInterface
{
...
export interface WhelpMultiHopInterface extends WhelpMultiHopReadOnlyInterface {
  contractAddress: string;
  sender: string;
  receive: (
    {
...
export class WhelpMultiHopClient
  extends WhelpMultiHopQueryClient
  implements WhelpMultiHopInterface
{
