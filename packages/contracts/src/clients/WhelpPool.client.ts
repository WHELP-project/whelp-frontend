...
import {
  ...
  TwapResponse,
} from "../types/WhelpPool.types";
export interface WhelpPoolReadOnlyInterface {
...
export class WhelpPoolQueryClient implements WhelpPoolReadOnlyInterface {
...
export interface WhelpPoolInterface extends WhelpPoolReadOnlyInterface {
  contractAddress: string;
  sender: string;
  receive: (
    {
...
export class WhelpPoolClient
  extends WhelpPoolQueryClient
  implements WhelpPoolInterface
{
