...
const WithdrawLiquiditySuccess = ({ ...props }: UiTypes.StatusModalProps) => (
  <>
    <Typography
      sx={{
        color: palette.textLoud,
...
const StakeLpSuccess = ({ ...props }: UiTypes.StatusModalProps) => (
  <>
    <Typography
      sx={{
        color: palette.textLoud,
...
const UnStakeLpSuccess = ({ ...props }: UiTypes.StatusModalProps) => (
  <>
    <Typography
      sx={{
        color: palette.textLoud,
